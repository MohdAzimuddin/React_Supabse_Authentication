const UserdataCard = ({ data }) => {
  return (
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 py-8 transition delay-500 ">
      {data.map((item) => (
        <div key={item.id} className="w-full p-3 md:p-4 lg:p-6 bg-gray-800 rounded-xl flex flex-col gap-2 shadow-sm shadow-green-400 hover:shadow-md hover:shadow-green-600">
